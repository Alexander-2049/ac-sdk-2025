...
const unusedFieldsInAssettoCorsaCompetizioneData = [
  "numberOfSessions",
  "playerNick",
  "maxTorque",
  "maxPower",
  "suspensionMaxTravelFL",
  "suspensionMaxTravelFR",
  "suspensionMaxTravelRL",
  "suspensionMaxTravelRR",
  "tireRadiusFL",
  "tireRadiusFR",
  "tireRadiusRL",
  "tireRadiusRR",
